...
Esta aplicação foi desenvolvida em React Js com a finalidade de obter a cotação das moedas através do consumo de uma API
...
A API utilizada para servir esta aplicação foi a <a href="https://docs.awesomeapi.com.br/api-de-moedas" target=_parent rel=noopener >API-DE-MOEDAS</a>
